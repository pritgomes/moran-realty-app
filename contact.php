...
*/
$emailto = 'martyn@promoran.com'; 	// Insert the email address that will receive the messages
$fromName = 'Moran Realty Inquiry';					// Insert a default "Name" email address (this fiel will be displayed in the email header)
$fromEmail = 'martyn@promoran.com';	// Insert a default "From" email address (this fiel will be displayed in the email header)
$subject = 'Moran Realty Contact Form';			// Insert a default conctact form subject
