...
function displayDynamicContent(all, current, residential, rental, sold, undercontract) {


    $("#home-slider").append(MoranRealty.Templates.homeSlider(current));
	$("#header").append(MoranRealty.Templates.header());
	$("#footer").append(MoranRealty.Templates.footer());
	$("#residential-property-listing").append(MoranRealty.Templates.residentialProperties(residential));
	$("#rental-property-listing").append(MoranRealty.Templates.rentalProperties(rental));
    $("#sold-property-listing").append(MoranRealty.Templates.soldProperties(sold));
    $("#under-contract-property-listing").append(MoranRealty.Templates.underContractProperties(undercontract));
	$("#similar-properties").append(MoranRealty.Templates.similarProperties(current));
	$("#single-property").append(MoranRealty.Templates.singleProperty(all));
